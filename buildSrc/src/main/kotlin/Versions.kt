...
object Versions {
    ...
    const val work_firebase: String = "1.0.0-alpha11" 
    ...
    const val crashlytics: String = "2.9.8" // available: "2.9.9"

    const val spotless_plugin_gradle: String = "3.16.0" // available: "3.17.0"
    ...
    const val rxandroid: String = "2.0.2" // available: "2.1.0"
    ...
    const val org_jetbrains_kotlin: String = "1.3.11" // available: "1.3.21"

    const val org_jetbrains_kotlinx: String = "1.0.0" // available: "1.1.1"

    const val mockito_android: String = "2.22.0" // available: "2.24.2"

    const val mockito_inline: String = "2.23.16" // available: "2.24.2"

    const val robolectric: String = "4.0.2" // available: "4.1"
